...
void main() {
    ...
    entries ~= Sidebar("mdi mdi-chart-line", "./statistics", "Statistics");
    ...
    s.registerVPSWidget(Widget("info", 6, 6, 6, 6, Widget.colors.white, Widget.colors.aqua, `
          <div class="box box-primary">     
            ...
            <div class="box-body">
              <div class="btn-group">
                <button style="width: 255px; height: 95px;" class="btn btn-app bg-green" data-toggle="tooltip" data-placement="top" title="Start">
                  <i class="fa fa-play" style="font-size: 35px;"></i>
                </button>
                <button style="width: 255px; height: 95px;" class="btn btn-app bg-yellow" data-toggle="tooltip" data-placement="top" title="Reboot">
                  <i class="fa fa-refresh" style="font-size: 35px;"></i>
                </button>
                <button style="width: 255px; height: 95px;" class="btn btn-app bg-red" data-toggle="tooltip" data-placement="top" title="Shutdown">
